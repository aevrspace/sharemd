...
const progressBarVariants = cva(
  "absolute left-0 h-1 bg-indigo-500 transition-all duration-300",
  {
    variants: {
      position: {
        top: "top-0",
      ...
      if (external) {
        return (
          <a
            ...
            className="block focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded-3xl"
          >
            {cardContent}
          </a>
        );
