      ...
      <div className="wrapper mx-auto flex max-w-5xl items-center justify-between gap-4 p-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-800"
            title="Toggle Theme"
          >
            {mounted ? (
              theme === "dark" ? (
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
              <div className="absolute right-0 top-full mt-2 w-80 rounded-xl border border-neutral-200 bg-white p-2 shadow-lg dark:border-neutral-800 dark:bg-neutral-900">
                ...
                {links.length === 0 ? (
                  <div className="px-2 py-8 text-center text-sm text-neutral-500 dark:text-neutral-400">
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    ...
                    {groups.length > 0 && (
                      <div className="mb-2 space-y-1">
                        <div className="px-2 text-xs font-semibold text-neutral-500 dark:text-neutral-400">
                          Groups
                        </div>
                        {groups.map((group) => (
                          <div
                            key={group.id}
                            className="rounded-lg bg-neutral-50/50 dark:bg-neutral-900/50"
                          >
                            <div
                              className="group flex items-center justify-between rounded-lg p-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 cursor-pointer"
                              onClick={() =>
                            ...
                            >
                              ...
                              <button
                                ...
                                className="ml-2 rounded p-1 text-neutral-400 opacity-0 hover:bg-red-50 hover:text-red-500 group-hover:opacity-100 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                                title="Delete Group"
                              >
                                <Trash
                                  size={14}
                            ...
                            {expandedGroups[group.id] && (
                              <div className="ml-6 space-y-1 border-l border-neutral-200 pl-2 dark:border-neutral-800">
                                {group.linkIds.map((linkId) => {
                                  ...
                                  return (
                                    <div
                                      key={linkId}
                                      className="group/item flex items-center justify-between rounded-md p-1.5 hover:bg-neutral-100 dark:hover:bg-neutral-800"
                                    >
                                      <Link
                                      ...
                                      <button
                                        ...
                                        className="ml-2 rounded p-0.5 text-neutral-400 opacity-0 hover:text-red-500 group-hover/item:opacity-100"
                    ...
                    {/* All Links Section */}
                    <div className="px-2 text-xs font-semibold text-neutral-500 dark:text-neutral-400 mt-2">
                      All Links
                    </div>
                    {links.map((link) => (
                      <div
                        key={link.id}
                        className="group flex items-center justify-between rounded-lg p-2 hover:bg-neutral-50 dark:hover:bg-neutral-800"
                      >
                        <Link
                          href={`/view?id=${link.id}`}
                          className="flex-1 overflow-hidden"
